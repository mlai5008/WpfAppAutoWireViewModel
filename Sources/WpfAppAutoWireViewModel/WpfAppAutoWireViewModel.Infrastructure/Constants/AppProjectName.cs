namespace WpfAppAutoWireViewModel.Infrastructure.Constants
{
    public class AppProjectName
    {
        #region Constants
        public const string InfrastructureAssembly = "WpfAppAutoWireViewModel.Infrastructure.dll";
